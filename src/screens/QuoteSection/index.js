...
const QuoteSection = props => {
  ...
  const {largeXTMargin, largeHMargin, smallBMargin,mediumTMargin, mediumVMargin,smallLMargin,mediumHMargin} = Gutters;
  ...
  return (
    <>
      ...
      <View style={[center,textWrapper]}>
        <Text style={[titleRegular,{textAlign:'center'}]} text={"Your daily dose of \ninspiration"}/>
      </View>
      <View style={quoteBox}>
        ...
        <View style={centerTextWrapper}>
          <DataAvailability
            ...
            <Text
              color="river"
              style={centerText}
              text="A great pleasure in life is doing what people say you cannot do"//{data && data[0].quote}
            />
          </DataAvailability>
        </View>
