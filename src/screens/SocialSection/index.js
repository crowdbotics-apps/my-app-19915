...
// components
import {Text, Header, MenuIcon, Avatar} from 'src/components';
import {Gutters, Images, Layout, Fonts} from 'src/theme';
const {smallVMargin, largeTMargin, largeLMargin} = Gutters;

const {fill, alignItemsCenter, justifyContentCenter} = Layout;
